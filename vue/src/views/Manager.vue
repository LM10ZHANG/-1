//主布局组件
//响应式布局（左侧固定菜单 + 右侧自适应内容）
//基于用户角色的动态菜单
//用户状态管理（从localStorage读取）
//统一的绿色主题样式
<template>
  <div>
    <div style="height: 60px; background-color: #a5d6a7; display: flex; align-items: center; border-bottom: 1px solid #ddd">
      <div style="flex: 1">
        <div style="padding-left: 20px; display: flex; align-items: center">
          <img src="@/assets/imgs/logo.png" alt="" style="width: 40px">
          <div style="font-weight: bold; font-size: 24px; margin-left: 5px">销售管理系统</div>
        </div>
      </div>
      ...
      <div style="width: 200px; border-right: 1px solid #ddd; min-height: calc(100vh - 60px)">
        ...
        >
          ...
          <el-sub-menu index="2">
            ...
            <el-menu-item index="/college"><el-icon><OfficeBuilding /></el-icon><span>订单信息</span></el-menu-item>
          </el-sub-menu>
...
<style scoped>
/* 菜单选中背景色从 #e0edfd 改为浅绿色 #e8f5e9 */
.el-menu-item.is-active {
  background-color: #e8f5e9 !important;
}
/* 菜单悬停字体颜色从 #1967e3 改为深绿色 #2e7d32 */
.el-menu-item:hover {
  color: #2e7d32;
}
:deep(th)  {
