...
<template>
  <div>
    ...
    <div class="card" style="margin-bottom: 5px;">
      <el-input v-model="data.name" style="width: 300px; margin-right: 10px" placeholder="请输入订单名称查询"></el-input>
    ...
    <div class="card" style="margin-bottom: 5px">
      ...
      <el-table :data="data.tableData" stripe>
        ...
        <el-table-column label="订单号" prop="content"></el-table-column>
        <el-table-column label="交付日期" prop="score"></el-table-column>
    ...
    <el-dialog title="订单信息" width="40%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="data.form" label-width="100px" style="padding-right: 50px">
        ...
        <el-form-item label="订单号" prop="content">
          <el-input v-model="data.form.content" autocomplete="off" />
        </el-form-item>
        <el-form-item label="交付日期" prop="score">
