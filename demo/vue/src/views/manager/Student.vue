...
<template>
  <div>
    <div class="card" style="margin-bottom: 5px">
      <el-input v-model="data.name" style="width: 300px; margin-right: 10px" placeholder="请输入销售员姓名"></el-input>
    ...
    <div class="card">
      ...
      <el-table :data="data.tableData" stripe>
        ...
        <el-table-column label="所属部门" prop="collegeName"></el-table-column>
    ...
    <el-dialog title="销售员信息" width="40%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="data.form" label-width="100px" style="padding-right: 50px">
        ...
        <el-form-item label="所属部门" prop="collegeId">
          <el-select v-model="data.form.collegeId" placeholder="请选择部门">
            <el-option
